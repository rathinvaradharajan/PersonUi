    ...
    describe("Verify Command", function () {
        ...
        context("with provider mock", function () {
            ...
            it("should work pointing to fake broker", function () {
                var p = CLI.runSync(["verify", "--provider-base-url", providerBaseUrl, "--pact-urls", path.resolve(__dirname, "integration/me-they-success.json")]).then(function (cp) { return cp.stdout; });
...
var CLI = (function () {
    ...
    CLI.commandRunning = function (c, amount) {
        ...
        amount++;
        var isSet = function () { return c.stdout.length !== 0 ? q.resolve() : q.reject(); };
        return isSet()
            .catch(function () {
            if (amount >= 10) {
