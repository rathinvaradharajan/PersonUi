# -*- encoding: utf-8 -*-
# stub: pact_broker-client 1.5.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["lib"]
  s.authors = ["Bethany Skurrie"]
  s.date = "2017-09-30"
  s.description = "Publishes pacts to, and retrieves pacts from, the pact broker server."
  s.email = ["bskurrie@dius.com.au"]
  s.executables = ["pact-publish"]
  s.files = ["bin/pact-publish"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<conventional-changelog>, [">= 0"])
      ...
      s.add_dependency(%q<conventional-changelog>, [">= 0"])
